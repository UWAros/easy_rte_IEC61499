...
var (
	inFileName  = flag.String("i", "out.xml", "Specifies the name of the source xml file to be compiled.")
	outLocation = flag.String("o", "example/ab5", "Specifies the name of the directory to put output files. If blank, uses current directory")
